...
public class AudioEncoderThreadOrigin extends Thread {
    ...
    public AudioEncoderThreadOrigin(WeakReference<MediaMuxerThread> mediaMuxerRunnable) {
    ...
    private void encode(final ByteBuffer buffer, final int length, final long presentationTimeUs) {
        ...
        do {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mBufferInfo.size != 0 && muxer != null && muxer.isMuxerTrackAddDone()) {
