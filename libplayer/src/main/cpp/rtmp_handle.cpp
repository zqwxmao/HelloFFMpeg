...
Java_com_michael_libplayer_ffmpeg_FFMpegHandle_pushRtmpFile(JNIEnv *env, jobject instance, jstring path_) {
...
Java_com_michael_libplayer_ffmpeg_FFMpegHandle_connect(JNIEnv *env, jobject instance, jstring url_) {
